...
export const Footer = () => {
    ...
    return (
        <div className={classnames('h-[65px] px-[8px] absolute bottom-0 bg-[#6EA5B1] left-0 right-0 opacity-10')} style={{ boxShadow: '6px -10px 13px -11px rgba(0, 0, 0, 0.5)' }} ref={item => { weddingText = item }}>
